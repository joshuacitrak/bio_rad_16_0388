function startAd(){  
    ...
    ttl.from("#t1", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 0.75)}, .4)
        .to("#t1", .7, { opacity:0, ease:Power3.easeOut}, 4)
        .from("#t2", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 0.75)}, 4.4)
        .to("#t2", .7, { opacity:0, ease:Power3.easeOut}, 8.5)
        .from("#t3", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 0.75)}, 9.15);
