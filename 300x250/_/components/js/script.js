function startAd(){  
    ...
    ptl.from("#p1", .7, {x: -50, opacity:0, ease: Elastic.easeOut.config(1, 0.75)})
    ...
    ttl.from("#t1", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 0.75)}, .25)
        .to("#t1", .7, { opacity:0, ease:Power3.easeOut}, 4)
        .from("#t2", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 0.75)}, 4.25)
        .to("#t2", .7, { opacity:0, ease:Power3.easeOut}, 8.5)
        .from("#t3", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 0.75)}, 8.75);
    ...
    cptl.from("#p5", .7, {x: -50, opacity:0, scale:.8, ease: Elastic.easeOut.config(1, 0.75)}, "cptl")
        .to("#p5", .7, {x: 250, opacity:0, scale:.8, ease:Power3.easeOut}, .7)
        .from("#p6", .7, {x: -50, opacity:0, scale:.8, ease: Elastic.easeOut.config(1, 0.75)}, .8)
