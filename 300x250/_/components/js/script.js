function startAd(){  
    ...
    ptl.from("#p1", .7, {x: -50, opacity:0, ease: Elastic.easeOut.config(1, 1)})
    ...
    .from("#p3a", .7, {x: -150, opacity:0, ease: Elastic.easeOut.config(1, 1)}, 4)
    ...
    .from("#p4", .7, {x: -150, opacity:0, ease: Elastic.easeOut.config(1, 1)}, 8.5)
    ...
    ttl.from("#t1", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 1)})
        .to("#t1", .7, { opacity:0, ease:Power3.easeOut}, 4)
        .from("#t2", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 1)}, 4)
        .to("#t2", .7, { opacity:0, ease:Power3.easeOut}, 8.5)
        .from("#t3", .7, {x: 300, opacity:0, ease: Elastic.easeOut.config(1, 1)}, 8.5);
    var ctl = new TimelineLite();
    ctl.from("#bradCtaButton", .4, {opacity:0,ease: Power3.easeOut});
    cptl.from("#p5", .7, {x: -50, opacity:0, scale:.8, ease: Elastic.easeOut.config(1, 1)}, "cptl")
        .to("#p5", .7, {x: 250, opacity:0, scale:.8, ease:Power3.easeOut}, .7)
        .from("#p6", .7, {x: -50, opacity:0, scale:.8, ease: Elastic.easeOut.config(1, 1)}, .8)
        .to("#p6", .7, {x: 250, opacity:0, scale:.8, ease:Power3.easeOut}, 1.5)
        .from("#p7", .7, {x: -50, opacity:0, scale:.8, ease: Elastic.easeOut.config(1, 1)}, 1.6)
        .to("#p5", .1, {x: -50, opacity:0, ease: Elastic.easeOut.config(1, 1)}, 1.6)
        .to("#p7", .7, {x: 250, opacity:0, scale:.8, ease:Power3.easeOut}, 2.4)
        .to("#p5", .7, {x: 22, opacity:1, scale:1, ease: Elastic.easeOut.config(1, 1)}, 2.4);
